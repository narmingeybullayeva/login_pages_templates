...
import ambulanceBg from '../../../assets/images/r.png';
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                        <div className="grid lg:grid-cols-2 min-h-[600px]">
                            ...
                            <div className=" bg-cover bg-center " style={{ backgroundImage: `url(${ambulanceBg})` }} ></div>
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <input
                                                    ...
                                                    className={`block w-full pl-10 pr-3 py-3 border rounded-lg focus:ring-2 focus:ring-[#254d87] focus:border-[#254d87] transition-colors 'border-gray-300'
                                                        }`}
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <input
                                                    ...
                                                    className={`block w-full pl-10 pr-10 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors  'border-gray-300'
                                                        }`}
